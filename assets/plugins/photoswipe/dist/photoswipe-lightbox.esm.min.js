...
class d {
    ...
    loadImage(t) {
        ...
        this.state = h,
        e.complete ? this.onLoaded() : (e.onload = () => {
            this.onLoaded()
        }
        ,
        e.onerror = () => {
...
function p(t, i, s) {
    ...
    if (n) {
        let o;
        e = new u(n,t,-1),
        o = i.pswp ? i.pswp.viewportSize : function(t, i) {
...
class v extends class extends class {
    ...
    addFilter(t, i, s=100) {
        var h, e, n;
        this.p[t] || (this.p[t] = []),
        null === (h = this.p[t]) || void 0 === h || h.push({
            fn: i,
            priority: s
        }),
...
}
{
    getNumItems() {
        ...
        s && "length"in s ? i = s.length : s && "gallery"in s && (s.items || (s.items = this.v(s.gallery)),
    ...
    getItemData(t) {
        ...
        let h = {};
        Array.isArray(s) ? h = s[t] : s && "gallery"in s && (s.items || (s.items = this.v(s.gallery)),
        h = s.items[t]);
        let e = h;
